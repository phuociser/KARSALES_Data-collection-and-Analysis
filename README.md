...
* Eliminate all Null variable form columns 'Dòng xe', 'Hãng' and 'Giá'  
* Replace null by mode of clolumns  'Số Chỗ', 'Tình Trạng', 'Hộp số', 'Nhiên liệu', 'Xuất sứ', 'Kiểu Dáng' and also get rid of 'Khác' variable from 'Số Chỗ' 
